...
### Before starting
1. Search GitHub for previous [issues](https://github.com/11notes/fork-dex/issues), [discussions](https://github.com/11notes/fork-dex/discussions) and [DEPs](https://github.com/11notes/fork-dex/tree/master/docs/enhancements).
2. If a discussion does not exist, [open it](https://github.com/11notes/fork-dex/discussions/new?category=Ideas).
